...
*/
case class UserAwareApiRequest[A](override val request: Request[A], apiKey: String, date: DateTime, token: Option[String], userId: Option[Users]) extends ApiRequest[A](request) {
...
*/
case class SecuredApiRequest[A](override val request: Request[A], apiKey: String, date: DateTime, token: String, userId: Users) extends ApiRequest[A](request)
