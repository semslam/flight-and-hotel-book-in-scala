...
(function ($) {
    ...
    Popup.prototype = {
        ...
        init: function(element, options) {
            ...
            if(!$(document).data('editable-handlers-attached')) {
                ...
                $(document).on('click.editable', function(e) {
                    ...
                    //if click inside one of exclude core --> no nothing
        ...
        **/         
        ...
        /* internal show method. To be overwritten in child core */
        innerShow: function () {
             
        },        

        /* internal hide method. To be overwritten in child core */
        innerHide: function () {
        ...
        **/        
        ...
        /* to be overwritten in child core */
...
@since 1.3.0
@example
<a href="#" id="email" data-type="email" data-pk="1">console@example.com</a>
<script>
$(function(){
    $('#email').editable({
        url: '/post',
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {  
            ...
            for(var i=0; i<classes.length; i++) {
                ...
                /*
                if(core[i].toLowerCase() === 'input-sm') {
