...
import models.PrivateUsers
import models.admin.MailTokenManager
import net.ceedubs.ficus.Ficus._
import net.ceedubs.ficus.readers.ArbitraryTypeReader._
import play.api.Configuration
import play.api.libs.concurrent.Execution.Implicits._
import utils.silhouette.{ MailTokenService, MyEnv }
...
class AdminSilhouetteModule extends AbstractModule with ScalaModule {
   ...
   */
  def configure() {
    bind[Silhouette[MyEnv[PrivateUsers]]].to[SilhouetteProvider[MyEnv[PrivateUsers]]]
    bind[IdentityService[PrivateUsers]].to[ManagerService]
  ...
  def provideEnvironment(
    ...
    eventBus: EventBus
  ): Environment[MyEnv[PrivateUsers]] = {
    Environment[MyEnv[PrivateUsers]](managerService, authenticatorService, Seq(), eventBus)
  }
